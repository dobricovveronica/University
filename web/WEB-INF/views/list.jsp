...
<table id="ViewStudents" class="table table-hover">
    ...
    <tr>
        <th scope="col">ID</th>
        <td><input type="checkbox" value="all" name="check"></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="check"  value="<%=student.getId()%>" onclick="idChecked(value)"></td>
        <td>Image</td>
...
<button type="submit" class="btn btn-secondary btm-sm" name="new" id="test"
        onclick="window.open('/student?action=ADD=','MyWindow' ,400,400);">Add New</button>
<button type="submit" class="btn btn-secondary btm-sm"  name="delete"
        onClick="refresh()">Delete</button>
</form>
