...
<form>
    ...
    <div class="form-group row">
        ...
        <div class="col-3">
            <input type="text" class="form-control" placeholder="First name" name="first_name" value="<%=student.getFirstName()%>">
        </div>
        <div class="col-1"></div>
        <div class="col-1">
        ...
        <div class="col-2">
            <select class="form-control">
                <option selected><%=student.getGroup().getName()%></option>
...
<div>
    <div class="form-group row">
        ...
        <div class="col-3">
            <input type="text" class="form-control" placeholder="Last name" name="last_name" value="<%=student.getLastName()%>">
        </div>
    </div>
    <div class="form-group row">
        <div class="col-1">
        ...
        <div class="col-3">
            <input type="date" class="form-control" name="date_of_birth" placeholder="Date of birth" value="<%=student.getDateOfBirth()%>">
        </div>
    </div>
    <div class="form-row">
        <div class="col-1">
        ...
        <div class="col-2">
            <div class="form-check form-check-inline">
                <input class="form-check-input col-4" type="radio" name="gender" value="male"> Male<br>
                <input class="form-check-input col-4" type="radio" name="gender" value="female"> Female<br>
            </div>
        </div>
    </div>
    <div class="form-row">
        ...
        <div class="col-3">
            <input type="text" class="form-control" placeholder="Country" name="country" value="<%=student.getAddresses().getCountry()%>">
        </div>
    </div>
    <br>
    <div class="form-row">
        ...
        <div class="col-3">
            <input type="text" class="form-control" placeholder="City" name="city" value="<%=student.getAddresses().getCity()%>">
        </div>
    </div>
    <br>
    <div class="form-row">
        ...
        <div class="col-3">
            <input type="text" class="form-control" placeholder="Address" name="address" value="<%=student.getAddresses().getAddress()%>">
        </div>
    </div>
    <br>
    <div class="form-row">
